...
import 'package:full_eshop_app/newscreen/home/homebody.dart';
import 'package:full_eshop_app/newscreen/home/model.dart';
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              /*Container(
                                width: MediaQuery.of(context).size.width-(MediaQuery.of(context).size.width*.3) -46.0,
                                  ...
                                  children: [
                                      ...
                                      child:  Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text.rich(
                                              TextSpan(
                                                text: "${model.prix_apres_promotion} DA",
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w600, color: kPrimaryColor),
                                                children: [
                                                  TextSpan(
                                                      text: " x${model.prix_originale}",
                                                      //style: Theme.of(context).textTheme.bodyText1,
                                                      style: TextStyle(
                                                          color: Colors.grey,
                                                          decoration: TextDecoration.lineThrough
                                    ...
                                    Positioned(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FlatButton(child:Icon(Icons.delete),onPressed: (){
                                          List list=config.sharedPreferences.getStringList('userCard');
                                          list.remove(model.name);
                                          FirebaseFirestore.instance.collection('users').doc(config.sharedPreferences.getString('uid')).update({
                                            'userCard':list
                                          }).then((value) {
                                            config.sharedPreferences.setStringList('userCard', list);
                                            //  Get.to(()=>CartScreen());
                                          });
                                        },
                                        ),
