...
class counters extends GetxController{
  final  counter=(config.sharedPreferences.getStringList('userCart').length-1).obs;
  Future<void> displayResult()async
  {
    int counter=config.sharedPreferences.getStringList('userCart').length-1;
